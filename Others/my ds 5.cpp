...
int main()
{
    ...
    while(ans=='y'||ans=='Y')
      {
         cout<<"WHICH DATA STRUCTURE YOU WANT TO EXECUTE \n";
	...
	//FLAG++;
    cout<<"PRESS FOR RETURNING TO THE MAIN MENU..............(y/n)";
	cin>>ans;
	system("cls");
        }
   // if(FLAG==1)
   //     exit();
   // else
   //     cout<<"PRESS IF YOU WANT TO EXECUTE ANOTHER DATA STRUCTURE............(y/n)"; 
   //     cin>>ans       
...
void linked_stack()
  { 
     ...
     while(ans=='y')
       {
           cout<<"\n HERE IS UR LINKED STACK";
           cout<<"\n1.Insert into the stack"<<"\n2.Delete from the  stack\n........";
           cin>>num;
	       switch(num)
              {
                  case 1:insert('e','l');
